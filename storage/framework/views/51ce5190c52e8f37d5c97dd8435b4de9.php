    ...
    <div style="background: #fff; border-radius: 20px; box-shadow: 0 3px 24px #1e465411; padding: 32px 40px; min-width: 400px; max-width:90vw;">
        ...
        <div style="display: flex; gap: 18px; justify-content:center; margin-bottom: 18px;">
            <div style="background:#2d88ff1a;color:#3795f6;padding:16px 30px; border-radius:10px; min-width:115px;box-shadow:0 1px 4px #2d88ff1c;">
                ...
                <div style="font-size:27px;font-weight:600;"><?php echo e($totalRooms); ?></div>
            </div>
            <div style="background:#00c89622; color:#36b37e; padding:16px 30px; border-radius:10px; min-width:115px;box-shadow:0 1px 4px #36b37e15;">
                ...
                <div style="font-size:27px;font-weight:600;"><?php echo e($totalAvailable); ?></div>
            </div>
            <div style="background:#f0810f1a;color:#f0810f; padding:16px 30px;border-radius:10px; min-width:115px;box-shadow:0 1px 4px #f0810f15;">
                ...
                <div style="font-size:27px;font-weight:600;"><?php echo e($totalCustomers); ?></div>
            </div>
        </div>
        <div style="display: flex; gap:24px; justify-content:center; margin-top:24px;">
            <a href="<?php echo e(route('rooms.index')); ?>" style="background:#3795f6;color:#fff;padding:13px 26px; border-radius:7px; font-weight:600; text-decoration:none;box-shadow:0 2px 8px #3795f622;">Quản lý phòng</a>
            <a href="<?php echo e(route('customers.index')); ?>" style="background:#36b37e; color:#fff; padding:13px 26px; border-radius:7px; font-weight:600; text-decoration:none;box-shadow:0 2px 8px #36b37e22;">Quản lý khách</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\btl\apartment-fee-management\resources\views/dashboard.blade.php ENDPATH**/ ?>