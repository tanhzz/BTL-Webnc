...
<div style="max-width:500px;margin:30px auto;background:#fff;padding:32px 36px 28px 36px;border-radius:16px;box-shadow:0 2px 20px #2d88ff11;">
    ...
    <form action="{{ route('rooms.store') }}" method="POST">
        ...
        <div style="margin-bottom:10px;">
            ...
            <input name="room_number" class="form-control" style="width:100%;border-radius:6px;" value="{{ old('room_number') }}">
        </div>
        <div style="margin-bottom:10px;">
            <label>Loại:</label>
            <input name="type" class="form-control" style="width:100%;border-radius:6px;" value="{{ old('type') }}">
        </div>
        <div style="margin-bottom:10px;">
            <label>Giá:</label>
            <input name="price" type="number" class="form-control" style="width:100%;border-radius:6px;" value="{{ old('price') }}">
        </div>
